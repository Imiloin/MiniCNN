...
module asdrlspkb1p64x16cm2sw0_conv_bias ( Q, ADR, D, WE, ME, CLK, TEST1, RM, RME);
...
generic_behav_asdrlspkb1p64x16cm2sw0_conv_bias #( MES_ALL) uut ( .Q(Q_tmp), .ADR(ADR), .D(D), .WE(WE), .ME(ME), .CLK(CLK) );
...
module generic_behav_asdrlspkb1p64x16cm2sw0_conv_bias (  Q, ADR, D, WE, ME, CLK );
