...
module asdrlspkb1p64x16cm2sw0_pwconv_weight (  Q, ADR, D, WE, ME, CLK, TEST1, RM, RME );
...
generic_behav_asdrlspkb1p64x16cm2sw0_pwconv_weight #( MES_ALL) uut ( .Q(Q_tmp), .ADR(ADR), .D(D), .WE(WE), .ME(ME), .CLK(CLK) );
...
module generic_behav_asdrlspkb1p64x16cm2sw0_pwconv_weight (  Q, ADR, D, WE, ME, CLK );

parameter MES_ALL = "ON";
parameter words = 32, bits = 128, addrbits = 5;
